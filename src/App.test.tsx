...
describe('App', () => {
  ...
  it('opens settings and renders the updated generation controls', async () => {
    ...
    expect(screen.getByLabelText('Endpoint URL')).toBeRequired()
    expect(screen.getByLabelText('API key')).toBeInTheDocument()
    expect(screen.getByLabelText('API key')).toBeRequired()
    expect(screen.getByLabelText('Model')).toBeInTheDocument()
    expect(screen.getByLabelText('Model')).toBeRequired()
    expect(screen.getByLabelText('Deployment name')).not.toBeRequired()
    ...
    expect(screen.getByLabelText('Max output tokens')).toHaveAttribute('min', '16')
    expect(screen.getByLabelText('Max output tokens slider')).toHaveAttribute('min', '16')
